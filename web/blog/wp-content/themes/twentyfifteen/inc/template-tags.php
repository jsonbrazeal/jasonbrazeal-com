...
function twentyfifteen_entry_meta() {
	...
	if ( in_array( get_post_type(), array( 'post', 'attachment' ) ) ) {
		...
		// uncomment the following to get the last modified time
	...
	// if ( 'post' == get_post_type() ) {
		// uncomment the following to get the author
		...
		// uncomment the following to get the categories list
		...
		// uncomment the following to enable the tags list
