...
export class MachineGraphic extends React.Component {
  ...
  render() {
    return(
      ...
      <svg ref={elem => this.machine = elem} className={graphics.machine} viewBox="0 -400 877 800" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
        <defs>
