...
export class MachineGraphic extends React.Component {
  render() {
    return(
      ...
      <path d="M444,253.145905 L456.942013,206" id="Line" stroke="#4DB09A" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none"></path>
      <path d="M418,247.205554 L432.815668,232" id="Line-Copy" stroke="#4DB09A" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none" transform="translate(425.407834, 239.602777) scale(1, -1) translate(-425.407834, -239.602777) "></path>
      <path d="M418,231.205554 L432.815668,216" id="Line-Copy-2" stroke="#4DB09A" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none"></path>
      <path d="M469,247.205554 L483.815668,232" id="Line-Copy-4" stroke="#4DB09A" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none" transform="translate(476.407834, 239.602777) scale(-1, -1) translate(-476.407834, -239.602777) "></path>
      <path d="M469,231.205554 L483.815668,216" id="Line-Copy-3" stroke="#4DB09A" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none" transform="translate(476.407834, 223.602777) scale(-1, 1) translate(-476.407834, -223.602777) "></path>
      <use id="code_window" stroke="#777777" mask="url(#mask-2)" stroke-width="2" fill="#FFFFFF" fill-rule="evenodd" xlinkHref="#path-1"></use>
      <g id="code" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(389.000000, 220.000000)" stroke-linecap="round" stroke-linejoin="round">
