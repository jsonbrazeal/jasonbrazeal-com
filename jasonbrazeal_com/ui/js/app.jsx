...
export class Typewriter extends React.Component {
  ...
  render() {
    let spans = [<span className={graphics.typewriterWrap}></span>, <span className={[graphics.typewriterCaret].join(" ")}>|</span>]
    return(
      <h2>
        <span
          ...
          {this.state.isMobile ? "coder." : null}
          {this.state.isMobile ? null : spans}
        </span>
      </h2>
    )
  }
